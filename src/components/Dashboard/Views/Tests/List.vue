  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <card>
            <button class="btn btn-primary" @click="goTo(`/admin/tests/create`)">Nova prova</button>
            <template slot="header">
              <h4 class="card-title">Provas</h4>
              <p class="card-category">Relação de provas</p>
            </template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      edit(id) {
        this.$router.push(`/tests/edit/${id}`);
      },
      goTo(url) {
        if (url) {
